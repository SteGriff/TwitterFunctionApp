...
namespace TwitterFunctionApp.Classes
{
    ...
    class TweetSender
    {
        ...
        /// "Your Access Token" heading.
        /// </summary>
        public TweetSender(TraceWriter logger, string consumerKey, string consumerKeySecret, string accessToken, string accessTokenSecret)
        {
            log = logger;
        ...
        Task<string> SendRequest(string url, Dictionary<string, string> data)
        {
            ...
            data.Add("oauth_nonce", CreateNonce());
            data.Add("oauth_token", accessToken);
            data.Add("oauth_version", "1.0");

            // Generate the OAuth signature and add it to our payload.
            var sig = GenerateSignature(fullUrl, data);
            data.Add("oauth_signature", sig);
